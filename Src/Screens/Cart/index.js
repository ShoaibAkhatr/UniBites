...
console.log('here is data that is come line no 17:::',savedData);
  ...
  return (
    <View style={styles.container}>
      <CartHeader title={'Cart'} onPressDelete={() => dispatch(clearCart())}/>
      <ScrollView>
        <FlatList
          data={savedData}
        ...
        <View style={styles.BottomView}>
          ...
          <Button title={'Checkout'} ButtonContainer={styles.ButtonContainerCheckout} ButtonText={styles.buttontext} onPress={() => navigation.navigate("Address")} />
        </View>
      </ScrollView>
    </View>
  )
